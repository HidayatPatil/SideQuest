				...
				<Link href="/">
					<div className={styles.navIcon}>
						<img
							...
							src={
								isActive("/") ? "/Icons/House_active.svg" : "/Icons/House.svg"
							}
							alt="Home Icon"
						/>
				...
				<Link href="/quest-board">
					<div className={styles.navIcon}>
						<img
							...
							alt="Quest Icon"
						/>
						{isActive("/quest-board") && <div className={styles.iconActive} />}
					</div>
				</Link>
				<Link href="/chat">
					<div className={styles.navIcon}>
						<img
							...
							alt="Chat Icon"
						/>
						{isActive("/chat") && <div className={styles.iconActive} />}
					</div>
				</Link>
				<Link href="/profile">
					<div className={styles.navIcon}>
						<img
							...
							alt="Profile Icon"
						/>
						{isActive("/profile") && <div className={styles.iconActive} />}
					</div>
				</Link>
			</div>
		</div>
